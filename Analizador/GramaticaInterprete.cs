...
namespace Proyecto1_Compiladores2.Analizador
{
    class GramaticaInterprete : Grammar
    {
        public GramaticaInterprete() : base(caseSensitive: false)
        {
            ...
            PROGRAMA.Rule = program_res + id + ";" + Z_DECLARACIONES_P + BEGIN_END + "."
                ;
            ...
            Z_CONSTANTES_P.Rule = Empty
                | const_res + D_CONSTANTE + ";" + R_CONSTANTE + Z_DECLARACIONES_P
            ...
            Z_VARIABLES_P.Rule = Empty
                | var_res + D_VARIABLE + ";" + R_VARIABLE + Z_DECLARACIONES_P
            ...
            Z_TIPOS_P.Rule = Empty
                | type_res + id + "=" + T_DATO + ";" + R_TYPE + Z_DECLARACIONES_P
                | id + "=" + T_DATO + ";" + R_TYPE + Z_DECLARACIONES_P
                ;
